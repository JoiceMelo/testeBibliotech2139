        ...
        <View style={styles.container}>
            ...
            <View style={styles.content}>
                ...
                <TextInput
                    ...
                    multiline
                />
                <TouchableOpacity style={[styles.button, { backgroundColor: '#ac58aa' }]} onPress={handleEditBook}>
                    <Text style={styles.buttonText}>Salvar alterações</Text>
                </TouchableOpacity>
                <TouchableOpacity style={[styles.button, { backgroundColor: '#ff6347' }]} onPress={handleCancelBook}>
